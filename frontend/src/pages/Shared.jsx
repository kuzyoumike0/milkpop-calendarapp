  ...
  return(<section className="card"><h2>共有スケジュール</h2>
    ...
    <div className="row" style={{alignItems:'flex-start'}}>
      <div style={{flex:'0 0 420px'}}>
        ...
        <div className="row" style={{marginTop:8}}><button className="button ghost" onClick={()=> setRange({start:today,end:today})}>今日</button><button className="button ghost" onClick={()=> setRange(r=>({start:r.start,end:null}))}>単日</button></div>
      </div>
