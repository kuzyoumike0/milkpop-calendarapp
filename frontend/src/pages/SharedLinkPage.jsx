      ...
      <main style={{ maxWidth: 900, margin: "2rem auto", padding: "1rem", background: "#fff", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            <thead>
              <tr>
                {["日","月","火","水","木","金","土"].map((d) => (
                  <th key={d} style={{ padding: "0.5rem", borderBottom: "2px solid #ff6f61", color: "#333" }}>{d}</th>
                ))}
              </tr>
            </thead>
            <tbody>
                    ...
                    <td
                      ...
                      style={{
                        ...
                        background: day.isToday
                          ...
                          ? "#fff"
                          : "#f5f5f5",
                        color: day.date.getDay() === 0 ? "red" : day.date.getDay() === 6 ? "blue" : "#333",
                      }}
                    >
                      {day.date.getDate()}
        ...
        <form onSubmit={handleSubmit} style={{ marginTop: "1.5rem", textAlign: "center" }}>
          <input
            ...
            style={{ padding: ".5rem", marginRight: "1rem", border: "1px solid #ddd", borderRadius: "6px" }}
          />
          <input
            type="text"
            value={title}
            ...
            style={{ padding: ".5rem", marginRight: "1rem", border: "1px solid #ddd", borderRadius: "6px" }}
          />
          <button type="submit" style={{ padding: ".5rem 1rem", background: "#ff6f61", color: "#fff", border: "none", borderRadius: "8px", cursor: "pointer" }}>
            登録
          </button>
        </form>
      </main>
