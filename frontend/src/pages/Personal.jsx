  ...
  return(<section className="card">
    ...
    <div className="row" style={{alignItems:'flex-start'}}>
      <div style={{flex:'0 0 420px'}}>
        <UniversalCalendar mode="range" year={y} month={m} range={range} onRangeChange={setRange} onPrev={prev} onNext={next} renderDay={renderDay} />
      ...
      <form onSubmit={add} className="card" style={{flex:'1 1 420px'}}>
        <div className="grid-form">
          ...
          <div className="full row" style={{marginTop:10}}>
            <button className="button" type="submit">追加（選択範囲）</button>
          </div>
        </div>
      </form>
    </div>
