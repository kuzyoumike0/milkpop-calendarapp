  ...
  return(<section className="card">
    ...
    <div className="row" style={{alignItems:'flex-start'}}>
      <div style={{flex:'0 0 420px'}}>
        <UniversalCalendar mode="multi" year={y} month={m} selectedDates={selected} onMultiChange={setSelected} onPrev={prev} onNext={next} renderDay={renderDay} disabledDates={Object.keys(map)} />
