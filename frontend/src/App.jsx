      ...
      <div className="nav">
        <div className="nav-inner">
          ...
          <nav style={{display:'flex', gap:8}}>
            <NavLink to="/" end className={({isActive})=> isActive ? 'active' : undefined}>トップ</NavLink>
            <NavLink to="/calendar" className={({isActive})=> isActive ? 'active' : undefined}>日付共有設定</NavLink>
