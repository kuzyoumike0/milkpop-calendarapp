    ...
    <div className="flex flex-col items-center justify-center mt-20 space-y-12">
      <Link
        ...
        className="block w-96 p-8 bg-pink-500/20 rounded-2xl shadow-lg text-center
                   hover:bg-pink-500/30 hover:scale-105 transition-all"
      >
        <h2 className="text-2xl font-bold text-[#FDB9C8] mb-2">日程登録ページ</h2>
      ...
      >
        <h2 className="text-2xl font-bold text-[#004CA0] mb-2">個人スケジュール</h2>
        <p className="text-gray-200 text-sm">
