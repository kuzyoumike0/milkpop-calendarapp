  ...
  return (
    <form className="form" onSubmit={submit}>
      ...
      <div className="field">
        ...
        <CalendarPicker value={selected} onChange={setSelected} highlightColor={(calendars.find(c=>c.id===calendarId)?.color) || "#22d3ee"} mode={selectionMode} size="sm" />
      </div>
      <div className="field">
        <label>予定</label>
      ...
      <div style={{display:'flex', gap:10}}>
        ...
        <button className="btn btn-secondary" type="reset" onClick={()=>{setTitle(""); setSelected(new Set()); setTimeslot("全日")}}>クリア</button>
      </div>
    </form>
  )
}
