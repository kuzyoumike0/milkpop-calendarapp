        ...
        {weeks.flat().map((d, idx) => {
          ...
          return (
            <button
              ...
              style={{
                height: 64, borderRadius: 12, padding: 0,
                opacity, background: bg, color, border, position:'relative', display:'grid', placeItems:'center'
              }}
              title={iso || ''}
            >
