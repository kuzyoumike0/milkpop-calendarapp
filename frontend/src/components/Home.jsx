    ...
    <div className="container">
      <div className="header">
        <div>
          ...
          <div className="sub">共有カレンダー管理へようこそ。用途に合わせて機能を選んでください。</div>
        </div>
      </div>
        ...
        <section className="col-8">
          <div className="panel">
            ...
            <div className="grid" style={{gridTemplateColumns: 'repeat(2, 1fr)'}}>
              <div className="card">
                <h4 style={{marginTop:0}}>共有カレンダーを見る</h4>
                <p className="sub">カレンダーを表示・フィルタし、予定を確認します。</p>
                <button className="btn" onClick={()=> nav('/calendar')}>カレンダーへ</button>
              </div>
              <div className="card">
