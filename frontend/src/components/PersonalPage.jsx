...
export default function PersonalPage() {
  ...
  const handleRegister = async () => {
    ...
    // ★ 即時に「あなたの個人日程（保存済み）」にも楽観追加（下に表示されない問題の解消）
    setMyEvents((prev) => {
      const optimistic = [
        ...prev,
        ...newItems.map((n) => ({
  ...
  return (
    <div className="personal-page">
      ...
      {/* 共有リンク一覧（外部ページに遷移のみ。ページ内プレビュー機能は削除） */}
      <section className="registered-list">
